...
from src.exchange_arbitrage_pkg.exchange_arbitrage_core_pkg.arbitrage_machine_pkg.arbitrage_machine import \
    ArbitrageMachine
...
class ArbitrageMachineMaker:
    def __init__(self,
        ...
        self.best_backup_rank_symbols_ex_1: List[Tuple[str, float]] = []
        self.best_backup_rank_symbols_ex_2: List[Tuple[str, float]] = []
    ...
    async def create_arbitrage_machine_for_one_bucket(self, df_in):
        ...
        df_ranked = self.symbol_evaluator_obj.evaluate_then_rank_best_symbols(df_bucket, self.exchange_pair)
    ...
    def extract_best_secondary(self, df_in, rank):
    ...
    def update_best_sell_symbols_info_(self, df_in):
        best_positive_values, \
            best_negative_values = self.extract_best_secondary(df_in,
