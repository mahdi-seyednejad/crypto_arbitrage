...
class ArbitrageMachinePunches:
    ...
    #
    #     if self.is_on_expensive_platform(desired_quantity):  # In this example, the dst is the expensive platform
    #         # desired_quantity = self.get_desired_quantity()
    ...
    #                                  reason='The secondary symbol is None. It should not be None',
    #                                  operation_executor=self.operation_executor,
    #                                  wait_time_info=self.wait_time_info,
    #                                  debug=self.debug)
    #             if self.debug:
    #                 print("The secondary symbol is None. It should not be None")
    #         else:
    #             desired_quantity = self.get_desired_quantity()
    #             secondary_quantity = convert_main_amount_to_secondary(desired_quantity,
    #                                                                   self.row[self.dst_price_col],
    ...
    #                                src_exchange_platform=self.src_exchange_platform,
    #                                dst_exchange_platform=self.dst_exchange_platform,
    #                                primary_desired_quantity=desired_quantity,
    #                                secondary_quantity=secondary_quantity,
    #                                operation_executor=self.operation_executor,
    #                                primary_withdraw_fee=self.withdraw_fee,
    #                                secondary_withdraw_fee=self.secondary_symbol_withdraw_fee,
    ...
    #                                 wait_time_info=self.wait_time_info,
    #                                 debug=self.debug)
    #         else:  # ToDO: Move this one to the highest if
    ...
    #                                      wait_time_info=self.wait_time_info,
    #                                      debug=self.debug)
    #                 raise Warning("The secondary symbol is None. It should not be None")
    #             else:
    #                 secondary_quantity = convert_main_amount_to_secondary(desired_quantity,
    #                                                                       self.row[self.dst_price_col],
    #                                                                       self.secondary_symbol_price)
